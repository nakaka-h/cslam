...
(cl:defmethod cl:initialize-instance :after ((m <cloud_info>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'cloud_info)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dcl_lio_sam-msg:<cloud_info> is deprecated: use dcl_lio_sam-msg:cloud_info instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <cloud_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dcl_lio_sam-msg:header-val is deprecated.  Use dcl_lio_sam-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'startRingIndex-val :lambda-list '(m))
(cl:defmethod startRingIndex-val ((m <cloud_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dcl_lio_sam-msg:startRingIndex-val is deprecated.  Use dcl_lio_sam-msg:startRingIndex instead.")
  (startRingIndex m))

(cl:ensure-generic-function 'endRingIndex-val :lambda-list '(m))
(cl:defmethod endRingIndex-val ((m <cloud_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dcl_lio_sam-msg:endRingIndex-val is deprecated.  Use dcl_lio_sam-msg:endRingIndex instead.")
  (endRingIndex m))

(cl:ensure-generic-function 'pointColInd-val :lambda-list '(m))
(cl:defmethod pointColInd-val ((m <cloud_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dcl_lio_sam-msg:pointColInd-val is deprecated.  Use dcl_lio_sam-msg:pointColInd instead.")
  (pointColInd m))

(cl:ensure-generic-function 'pointRange-val :lambda-list '(m))
(cl:defmethod pointRange-val ((m <cloud_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dcl_lio_sam-msg:pointRange-val is deprecated.  Use dcl_lio_sam-msg:pointRange instead.")
  (pointRange m))

(cl:ensure-generic-function 'imuAvailable-val :lambda-list '(m))
(cl:defmethod imuAvailable-val ((m <cloud_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dcl_lio_sam-msg:imuAvailable-val is deprecated.  Use dcl_lio_sam-msg:imuAvailable instead.")
  (imuAvailable m))

(cl:ensure-generic-function 'odomAvailable-val :lambda-list '(m))
(cl:defmethod odomAvailable-val ((m <cloud_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dcl_lio_sam-msg:odomAvailable-val is deprecated.  Use dcl_lio_sam-msg:odomAvailable instead.")
  (odomAvailable m))

(cl:ensure-generic-function 'imuRollInit-val :lambda-list '(m))
(cl:defmethod imuRollInit-val ((m <cloud_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dcl_lio_sam-msg:imuRollInit-val is deprecated.  Use dcl_lio_sam-msg:imuRollInit instead.")
  (imuRollInit m))

(cl:ensure-generic-function 'imuPitchInit-val :lambda-list '(m))
(cl:defmethod imuPitchInit-val ((m <cloud_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dcl_lio_sam-msg:imuPitchInit-val is deprecated.  Use dcl_lio_sam-msg:imuPitchInit instead.")
  (imuPitchInit m))

(cl:ensure-generic-function 'imuYawInit-val :lambda-list '(m))
(cl:defmethod imuYawInit-val ((m <cloud_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dcl_lio_sam-msg:imuYawInit-val is deprecated.  Use dcl_lio_sam-msg:imuYawInit instead.")
  (imuYawInit m))

(cl:ensure-generic-function 'initialGuessX-val :lambda-list '(m))
(cl:defmethod initialGuessX-val ((m <cloud_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dcl_lio_sam-msg:initialGuessX-val is deprecated.  Use dcl_lio_sam-msg:initialGuessX instead.")
  (initialGuessX m))

(cl:ensure-generic-function 'initialGuessY-val :lambda-list '(m))
(cl:defmethod initialGuessY-val ((m <cloud_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dcl_lio_sam-msg:initialGuessY-val is deprecated.  Use dcl_lio_sam-msg:initialGuessY instead.")
  (initialGuessY m))

(cl:ensure-generic-function 'initialGuessZ-val :lambda-list '(m))
(cl:defmethod initialGuessZ-val ((m <cloud_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dcl_lio_sam-msg:initialGuessZ-val is deprecated.  Use dcl_lio_sam-msg:initialGuessZ instead.")
  (initialGuessZ m))

(cl:ensure-generic-function 'initialGuessRoll-val :lambda-list '(m))
(cl:defmethod initialGuessRoll-val ((m <cloud_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dcl_lio_sam-msg:initialGuessRoll-val is deprecated.  Use dcl_lio_sam-msg:initialGuessRoll instead.")
  (initialGuessRoll m))

(cl:ensure-generic-function 'initialGuessPitch-val :lambda-list '(m))
(cl:defmethod initialGuessPitch-val ((m <cloud_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dcl_lio_sam-msg:initialGuessPitch-val is deprecated.  Use dcl_lio_sam-msg:initialGuessPitch instead.")
  (initialGuessPitch m))

(cl:ensure-generic-function 'initialGuessYaw-val :lambda-list '(m))
(cl:defmethod initialGuessYaw-val ((m <cloud_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dcl_lio_sam-msg:initialGuessYaw-val is deprecated.  Use dcl_lio_sam-msg:initialGuessYaw instead.")
  (initialGuessYaw m))

(cl:ensure-generic-function 'cloud_deskewed-val :lambda-list '(m))
(cl:defmethod cloud_deskewed-val ((m <cloud_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dcl_lio_sam-msg:cloud_deskewed-val is deprecated.  Use dcl_lio_sam-msg:cloud_deskewed instead.")
  (cloud_deskewed m))

(cl:ensure-generic-function 'cloud_corner-val :lambda-list '(m))
(cl:defmethod cloud_corner-val ((m <cloud_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dcl_lio_sam-msg:cloud_corner-val is deprecated.  Use dcl_lio_sam-msg:cloud_corner instead.")
  (cloud_corner m))

(cl:ensure-generic-function 'cloud_surface-val :lambda-list '(m))
(cl:defmethod cloud_surface-val ((m <cloud_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dcl_lio_sam-msg:cloud_surface-val is deprecated.  Use dcl_lio_sam-msg:cloud_surface instead.")
  (cloud_surface m))

(cl:ensure-generic-function 'key_frame_cloud-val :lambda-list '(m))
(cl:defmethod key_frame_cloud-val ((m <cloud_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dcl_lio_sam-msg:key_frame_cloud-val is deprecated.  Use dcl_lio_sam-msg:key_frame_cloud instead.")
  (key_frame_cloud m))

(cl:ensure-generic-function 'key_frame_color-val :lambda-list '(m))
(cl:defmethod key_frame_color-val ((m <cloud_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dcl_lio_sam-msg:key_frame_color-val is deprecated.  Use dcl_lio_sam-msg:key_frame_color instead.")
  (key_frame_color m))

(cl:ensure-generic-function 'key_frame_poses-val :lambda-list '(m))
(cl:defmethod key_frame_poses-val ((m <cloud_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dcl_lio_sam-msg:key_frame_poses-val is deprecated.  Use dcl_lio_sam-msg:key_frame_poses instead.")
  (key_frame_poses m))

(cl:ensure-generic-function 'key_frame_map-val :lambda-list '(m))
(cl:defmethod key_frame_map-val ((m <cloud_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dcl_lio_sam-msg:key_frame_map-val is deprecated.  Use dcl_lio_sam-msg:key_frame_map instead.")
  (key_frame_map m))
