...
(cl:defmethod cl:initialize-instance :after ((m <save_map-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'save_map-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dcl_lio_sam-srv:<save_map-request> is deprecated: use dcl_lio_sam-srv:save_map-request instead.")))

(cl:ensure-generic-function 'resolution-val :lambda-list '(m))
(cl:defmethod resolution-val ((m <save_map-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dcl_lio_sam-srv:resolution-val is deprecated.  Use dcl_lio_sam-srv:resolution instead.")
  (resolution m))

(cl:ensure-generic-function 'destination-val :lambda-list '(m))
(cl:defmethod destination-val ((m <save_map-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dcl_lio_sam-srv:destination-val is deprecated.  Use dcl_lio_sam-srv:destination instead.")
  (destination m))
...
(cl:defmethod cl:initialize-instance :after ((m <save_map-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'save_map-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dcl_lio_sam-srv:<save_map-response> is deprecated: use dcl_lio_sam-srv:save_map-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <save_map-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dcl_lio_sam-srv:success-val is deprecated.  Use dcl_lio_sam-srv:success instead.")
  (success m))
