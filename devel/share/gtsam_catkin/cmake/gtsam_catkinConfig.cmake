...
if("TRUE" STREQUAL "TRUE")
  set(gtsam_catkin_SOURCE_PREFIX /home/hiroki/cslam_ws/src/gtsam_catkin)
  set(gtsam_catkin_DEVEL_PREFIX /home/hiroki/cslam_ws/devel)
  ...
  set(gtsam_catkin_INSTALL_PREFIX /home/hiroki/cslam_ws/install)
...
if(NOT "/home/hiroki/cslam_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gtsam_catkin' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hiroki/cslam_ws/src/gtsam_catkin/${idir}'.  ${_report}")
    endif()
    _list_append_unique(gtsam_catkin_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "CppUnitLite;gtsam;gtsam_unstable;metis;tbb")
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT gtsam_catkin_NUM_DUMMY_TARGETS)
      set(gtsam_catkin_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::gtsam_catkin::wrapped-linker-option${gtsam_catkin_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR gtsam_catkin_NUM_DUMMY_TARGETS "${gtsam_catkin_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::gtsam_catkin::wrapped-linker-option${gtsam_catkin_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND gtsam_catkin_LIBRARIES "${interface_target_name}")
  elseif(${library} MATCHES "^\\$<")
    list(APPEND gtsam_catkin_LIBRARIES ${library})
...
set(depends "eigen_catkin;metis_catkin")
foreach(depend ${depends})
  ...
  _list_append_deduplicate(gtsam_catkin_EXPORTED_TARGETS ${${gtsam_catkin_dep}_EXPORTED_TARGETS})
endforeach()
