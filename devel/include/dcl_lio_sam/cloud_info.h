// Generated by gencpp from file dcl_lio_sam/cloud_info.msg
// DO NOT EDIT!


#ifndef DCL_LIO_SAM_MESSAGE_CLOUD_INFO_H
#define DCL_LIO_SAM_MESSAGE_CLOUD_INFO_H
...
struct cloud_info_
{
  ...
  typedef boost::shared_ptr< ::dcl_lio_sam::cloud_info_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::dcl_lio_sam::cloud_info_<ContainerAllocator> const> ConstPtr;

}; // struct cloud_info_

typedef ::dcl_lio_sam::cloud_info_<std::allocator<void> > cloud_info;

typedef boost::shared_ptr< ::dcl_lio_sam::cloud_info > cloud_infoPtr;
typedef boost::shared_ptr< ::dcl_lio_sam::cloud_info const> cloud_infoConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::dcl_lio_sam::cloud_info_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::dcl_lio_sam::cloud_info_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::dcl_lio_sam::cloud_info_<ContainerAllocator1> & lhs, const ::dcl_lio_sam::cloud_info_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::dcl_lio_sam::cloud_info_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::dcl_lio_sam::cloud_info_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::dcl_lio_sam::cloud_info_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::dcl_lio_sam::cloud_info_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dcl_lio_sam::cloud_info_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dcl_lio_sam::cloud_info_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::dcl_lio_sam::cloud_info_<ContainerAllocator> >
{
  ...
  static const char* value(const ::dcl_lio_sam::cloud_info_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xb654dbfca2e5288eULL;
  static const uint64_t static_value2 = 0xff9e25937cb8519eULL;
};

template<class ContainerAllocator>
struct DataType< ::dcl_lio_sam::cloud_info_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::dcl_lio_sam::cloud_info_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# Cloud Info\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::dcl_lio_sam::cloud_info_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::dcl_lio_sam::cloud_info_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::dcl_lio_sam::cloud_info_<ContainerAllocator>& v)
  {
    ...
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "startRingIndex: ";
    if (v.startRingIndex.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.startRingIndex.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<int32_t>::stream(s, true ? std::string() : indent + "    ", v.startRingIndex[i]);
    }
    if (v.startRingIndex.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "endRingIndex: ";
    if (v.endRingIndex.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.endRingIndex.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<int32_t>::stream(s, true ? std::string() : indent + "    ", v.endRingIndex[i]);
    }
    if (v.endRingIndex.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "pointColInd: ";
    if (v.pointColInd.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.pointColInd.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<int32_t>::stream(s, true ? std::string() : indent + "    ", v.pointColInd[i]);
    }
    if (v.pointColInd.empty() || true)
      s << "]";
    if (true || !indent.empty())
    ...
    for (size_t i = 0; i < v.pointRange.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<float>::stream(s, true ? std::string() : indent + "    ", v.pointRange[i]);
    }
    if (v.pointRange.empty() || true)
      s << "]";
    if (true || !indent.empty())
...
#endif // DCL_LIO_SAM_MESSAGE_CLOUD_INFO_H
